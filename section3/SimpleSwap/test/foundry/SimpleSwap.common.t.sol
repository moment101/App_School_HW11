...
contract SimpleSwapKValueCheck is SimpleSwapSetUp {
    ...
    function test_kValue_should_be_the_greater_after_swaps() public {
        ...
        uint256 reserveB;
        (reserveA, reserveB) = simpleSwap.getReserves();
        console.log("After swap reserveA * reserveB:", reserveA * reserveB);
        assertGt(reserveA * reserveB, K);

        // Without Ceil
        // K   9000000000000000000000000000000000000000
        // x*y 8999999999999999999760000000000000000000

        // With Ceil
        // K   9000000000000000000000000000000000000000
        // x*y 9000000000000000000240000000000000000000
    }
}
